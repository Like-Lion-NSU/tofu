...
const mbtidetails = {
    'ENFJ' : (
        <>
            ...
            <p>다른 사람들의 생각이나 의견에 진지한 관심을 가지고 공동의 목표를 위하여 다른 사람의 의견에 대체로 동의합니다.</p>
            <p>미래의 가능성을 추구하며 편안하고 능숙하게 계확을 제시하여 집단을 이끌어가는 능력이 있습니다.</p>
        </>
    ),
    'ENFP' : (
        <>
            ...
            <p>온화하고 창의적이며 항상 새로운 가능성을 찾아 시도하는 유형입니다.</p>
            <p>문제 해결이 빠르고, 관심 있는 일은 무엇이든지 수행해내는 능력과 열정이 있습니다.</p>
            <p>다른 사람들에게 관심을 쏟으며 사람들을 잘 다루고 뛰어난 통찰력으로 도움을 줍니다.</p>
        </>
    ),
    'ENTJ' : (
        <>
            ...
            <p>{'('}대담한 통솔자, 지도자형{')'}</p>
            <p>열성이 많으며, 자기주장이 강하면서 단호하고, 지도력과 통솔력이 있습니다.</p>
            <p>타고난 지도자형으로 일은 일대로, 욕은 욕대로 먹을 수 있습니다.</p>
            <p>너무 완벽주의를 추구하기 때문에 남이 비집고 들어갈 틈이 없을 수 있습니다.</p>
            <p>지적 욕구가 강하고, 감정표현이 솔직해서 타인이 상처를 받을 수 있습니다.</p>
            <p>가끔 엉뚱할 때도 있습니다.</p>
        </>
    ),
    'ENTP' : (
        <>
            ...
            <p>본인이 구상하는 바를 실현시키고 싶어하는 기질이 강하며, 아웃사이더적인 성격이 겹쳐 혁명가의 기질을 띄고 있습니다.</p>
            <p>모든 분야의 기존체제 자체를 뒤집어 버리거나 분야 전체의 도약을 이루는 인물들이 많기도 합니다.</p>
    ...
    'ESFJ' : (
        <>
            ...
            <p>이야기 하는 것을 즐기며 정리정돈을 잘 합니다.</p>
            <p>참을성이 많고 다른 사람들을 잘 도와줍니다.</p>
            <p>사람을 다루고 행동하는 분야에 적합합니다.</p>
            <p>거절 당했을 때 마음의 상처를 받습니다.</p>
        </>
    ),
    'ESFP' : (
        <>
            ...
            <p>때로는 수다스럽고 진지함이 결여되거나 마무리를 잘 못하는 경향이 있습니다.</p>
        </>
    ),
    'ESTJ' : (
        <>
            ...
            <p>실질적이고 현실 감각이 뛰어나, 일을 조직하고 계획하여 추진시키는 능력이 있습니다.</p>
            <p>자기 또는 타인의 감정을 고려하는 능력이 부족하여 속단속결하는 경향이 있을 수 있습니다.</p>
            <p>지나치게 업무 위주로 대하는 경향이 있기도 합니다.</p>
        </>
    ),
    'ESTP' : (
        <>
            <p>당신은 강한 현실감각으로 문제를 해결하는, 뜨거운 기름에서도 살아남는 두부강정입니다!</p>
            <p>{'('}모험을 즐기는 사업가, 수완 좋은 활동가형{')'}</p>
            <p>사실적이고 관대하며 개방적으로, 사람이나 사물에 대한 선입견이 별로 없습니다.</p>
            <p>강한 현실 감각으로 타협책을 모색하여 문제 해결능력이 뛰어납니다.</p>
            <p>센스 있고 유머러스합니다.</p>
            <p>어디서든 적응을 잘 하고 친구와 어울리기 좋아합니다.</p>
        </>
    ),
    'INFJ' : (
        <>
            <p>당신은 다양한 사람과 잘 어울리는, 어떤 양념이든 잘 어울리는 두부조림입니다!</p>
            <p>{'('}통찰력 있는 선지자, 예언가형{')'}</p>
            <p>인내심이 많고 통찰력과 직관력이 뛰어나며 화합을 추구합니다.</p>
            <p>창의력이 좋으며 성숙한 경우엔 강한 직관력으로 타인에게 영향을 끼칩니다.</p>
            <p>친한 친구나 지인 앞에서 미래에 대한 각종 예측과 상상에 대한 말을 하기 좋아하는 특성이 있습니다.</p>
    ...
    'INFP' : (
        <>
            ...
            <p>낭만적인 성향으로 보이지만 내적신념이 깊은 정열적인 중재자 유형입니다.</p>
            <p>개인주의자이며, 이상주의자이고 이해력이 높습니다.</p>
            <p>적응력이 좋으며 대체로 관대하고 개방적이기도 합니다.</p>
            <p>호기심이 많으며 어떠한 일의 결과보다 가능성을 보는 경향이 있습니다.</p>
    ...
    'INTJ' : (
        <>
            <p>
                두부로도 고기맛을 낼 수 있다!<br/>
                당신은 두부로도 고기맛을 낼 수 있는 두부스테이크입니다!
            </p>
            <p>{'('}용의주도한 전략가형{')'}</p>
            <p>고집이 세고 융통성이 부족합니다.</p>
            <p>자기 관심 분야 외에는 신경을 거의 쓰지 않습니다.</p>
            <p>자신의 능력에 대해 자신감이 있고 높이 평가합니다.</p>
            <p>타인에게 잘 보이고 싶다는 욕구가 없고 공감을 잘 못합니다.</p>
            <p>유행과 관심사가 동떨어져 있으며 목표에 달성하면 행복을 느낍니다.</p>
        </>
    ),
    'INTP' : (
        <>
            ...
            <p>먼저 대화를 시작하지 않는 편이지만 관심있는 분야에 대하여 말을 많이 하는 편입니다.</p>
            <p>이해가 빠르고 모두의 의견을 수렴하고자 노력합니다.</p>
            <p>규칙과 법에 얽매이는 것을 싫어하는 성격입니다.</p>
            <p>다소 반항적인 부분도 있으며 비판적이고 게으른 편입니다.</p>
        </>
    ),
    'ISFJ' : (
        <>
            <p>당신은 두부와 김치의 조합처럼 적은 사람과 영혼의 파트너인 두부김치입니다!</p>
            <p>{'('}용감한 수호자, 실용적인 조력가{')'}</p>
            <p>조용하고 차분하며 따뜻하고 친근합니다.</p>
            <p>책임감과 인내력 또한 매우 강하고 본인의 친한 친구나 가족에게 애정이 가득합니다.</p>
            <p>언제나 진솔하려고 노력하고 가볍지 않기 때문에 관계를 맺기 가장 믿음직스러운 유형입니다.</p>
            <p>이상과 달리 귀찮은 일이 생겼을 때, 자신에게도 극심한 괴리감을 느끼는 유형입니다.</p>
        </>
    ),
    'ISFP' : (
        <>
            ...
            <p>의견충돌을 피하고 평화를 중시합니다.</p>
            <p>사람과 관계된 일을 할 때 자신의 감정과 타인의 감정에 지나치게 민감한 경향이 있습니다.</p>
    ...
    'ISTJ' : (
        <>
            ...
            <p>낯가림이 심한편이고 선입견이 강합니다.</p>
            <p>예고없이 갑작스러운 변화를 매우 싫어합니다.</p>
            <p>실수한 것을 참지 못하고 즉각 수정하기를 원합니다.</p>
        </>
    ),
    'ISTP' : (
        <>
            ...
            <p>조용히 자기 일만 하고 있는 것처럼 보이지만 사실 주변 상황파악도 다 하고 있습니다.</p>
            <p>사회성이 부족한 편입니다.</p>
            <p>손재주가 뛰어나며 말이 없고 타인에 대한 마음표현을 어려워합니다.</p>
...
return(
    <>
      <div className="result">
        <h2 className="result-title">당신과 어울리는 두부는 
        <br/>
      ...
      <div className="result-box">
        <div className="result-box__analyze">
            <div className="result-box__analyze--tofuTypeImg" style={{
                backgroundImage :`url(${imgpath})`,
                backgroundPosition : 'center',
                backgroundRepeat : 'no-repeat'
                }}>
            </div>
            <div className="result-box__analyze--analysisTable" style={{color:"white"}}> 
            {mbtidetails[mbti]}
            </div>
        </div>
      </div>
      ...
      <div className="result-bestWorst">
        <div className="result-best" style={{
            backgroundImage : `url(${bestImg})`,
            backgroundPosition : 'center',
            backgroundRepeat : 'no-repeat'
        }}></div>
        <div className="result-worst" style={{
